...
public class EmailService 
{
	...
	public EmailConfigData getEmailConfig()
    {
		...
		EmailConfigData emailConfigData = new EmailConfigData(
				EmailConstants.mailHost,EmailConstants.mailPort,EmailConstants.mailUsername,EmailConstants.mailPassword
				...
				/*webClientBuilder.build()
					    	.get()
					    	.uri(reqUrl+"/emailconfig")
					    	.header("Authorization", request.getHeader("Authorization"))
					    	.retrieve()
					    	.bodyToMono(EmailConfigData.class)
					    	.block();
