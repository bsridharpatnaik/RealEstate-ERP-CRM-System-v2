...
public class CategoryController 
{
	...
	public AllCategoriesWithNamesData returnFilteredCategories(@RequestBody FilterDataList filterDataList,@PageableDefault(page = 0, size = 10, sort = "created", direction = Direction.DESC) Pageable pageable)
	{
