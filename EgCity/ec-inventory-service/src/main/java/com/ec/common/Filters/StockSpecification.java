...
public class StockSpecification 
{
	...
	public static Specification<Stock> getSpecification(FilterDataList filterDataList)
	{
		...
		if(globalSearch != null && globalSearch.size()>0)
		{
			...
			internalSpec = specbldr.specOrCondition(internalSpec, specbldr.whereChildFieldContains(Stock_.PRODUCT,Product_.PRODUCT_NAME, globalSearch));
			internalSpec = specbldr.specOrCondition(internalSpec,specbldr.whereChildFieldContains(Stock_.WAREHOUSE,Warehouse_.WAREHOUSE_NAME,globalSearch));
