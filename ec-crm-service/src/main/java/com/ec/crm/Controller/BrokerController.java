...
public class BrokerController {
	...
	@GetMapping("/{id}")
	public Broker findAddressByID(@PathVariable long id) throws Exception 
	{
	...
	public Broker createUser(@RequestBody Broker broker) throws Exception{
		
		return brokerService.createBroker(broker);
	}
	
	@PutMapping("/{id}")
	public Broker updateUser(@PathVariable Long id, @RequestBody Broker broker) throws Exception 
	{
